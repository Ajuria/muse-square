...
(function () {
  ...
  function openBrouillonLibrary(opts) {
    ...
    + '</div>';
    var SIGNAL_LABELS = {weather_worsened:"Météo dégradée",weather_improved:"Météo améliorée",weather_hazard_onset:"Alerte météo",competitor_event_launch:"Lancement concurrent",competitor_audience_conflict:"Conflit audience",competition_pressure_spike:"Pression concurrentielle",competitor_event_ending:"Fin concurrent",mobility_disruption:"Perturbation mobilité",score_up:"Score en hausse",_day_opportunity:"Opportunité jour",_best_day:"Meilleur jour",score_down:"Score en baisse",sales_surge:"CA au-dessus de votre résultat habituel",sales_revenue_down_wow:"CA sous votre résultat habituel",sales_traffic_not_converting:"Trafic sans conversion",sales_discount_no_lift:"Remise sans effet"};
    var cards = '';
