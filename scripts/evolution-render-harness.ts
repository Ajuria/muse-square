...
// public/evolution-render-harness.html (7 documents rendus + styles réels).
// Usage : npx tsx scripts/evolution-render-harness.ts
...
(async () => {
  ...
  const dest = new URL("../public/evolution-render-harness.html", import.meta.url).pathname;
