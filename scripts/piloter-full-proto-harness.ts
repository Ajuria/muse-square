...
// Usage : npx tsx scripts/piloter-full-proto-harness.ts
...
(async () => {
  ...
  writeFileSync(new URL("../public/piloter-full-proto-data.js", import.meta.url).pathname, "window.PILOTER_FULL = " + JSON.stringify(out, null, 1) + ";\n");
