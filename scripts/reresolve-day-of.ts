// scripts/reresolve-day-of.ts — RE-RÉSOUDRE les « jour même » mesurés le jour de CRÉATION.
//
...
//
//   npx tsx scripts/reresolve-day-of.ts          → aperçu, aucune écriture
//   npx tsx scripts/reresolve-day-of.ts --ecrire → applique
