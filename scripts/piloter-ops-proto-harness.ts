...
// Capture le glance RÉEL (dashboard direct, 3 sites owner) → public/piloter-ops-proto-data.js.
...
// Usage : npx tsx scripts/piloter-ops-proto-harness.ts
...
(async () => {
  ...
  writeFileSync(new URL("../public/piloter-ops-proto-data.js", import.meta.url).pathname,
    "window.PILOTER_OPS = " + JSON.stringify(out, null, 1) + ";\n");
  console.log("mesures réelles:", (out.mesures || []).length, "· écrit public/piloter-ops-proto-data.js");
