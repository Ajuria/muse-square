...
| `vw_insight_event_day_notes` 🆕 | view | note_id (une ligne par note, append-only — la dernière d'un jour fait foi) | stg_day_notes → analytics.day_notes | note_id, location_id, clerk_user_id, date, note_text, created_at | **passation à coller** (`docs/dbt-handoff/HANDOFF-day-notes-2026-09-07.md`, owner 07/09) : la note-cause d'un jour écrite depuis l'état vide d'Explorer ; l'app écrit la table et la lit en direct (app-write, comme action_log) ; jointure prévue au résiduel du jour par (location_id, date) |
...
| `stg_day_notes` 🆕 | view | src:analytics.day_notes — **passation à coller** (`docs/dbt-handoff/HANDOFF-day-notes-2026-09-07.md`, owner 07/09) ; la table existe en base |
