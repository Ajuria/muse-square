...
| `mart.fct_client_family_price_daily` (carte `family_price_move`, bloc candidat 06/09 : un tir par site et par jour, famille au \|z\| le plus fort) | site × jour × famille | stg_client_transactions | prix réalisé (CA/unités), taux de remise ; base 28 j ; is_price_move (units ≥ 10), is_discount_move |
