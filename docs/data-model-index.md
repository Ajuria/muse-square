...
| `stg_client_transactions` 🆕 | view | src:raw.client_transactions, src:analytics.import_routing_rules, src:analytics.import_invoice_parties, src:analytics.party_directory |
