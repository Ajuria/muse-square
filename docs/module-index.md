...
| `insight/reactions-today.ts` | GET | Type B: today's active env factors + sensitivity reactions, optional track record + recommended moves | `mart.fct_location_context_daily`, `analytics.b_demo_sensitivity`, `analytics.b_demo_commitment` |
...
| `insight/sensitivities.ts` | GET | Returns venue sensitivity profiles (Type B) at tier level | `analytics.b_sensitivity_store` (demo) / real store |
