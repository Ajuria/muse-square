...
| Ce qui reste du CA net HT après le coût d'achat HT des articles vendus | **marge brute** (owner 11/09) ; son taux se dit **taux de marge brute** ; ne se montre qu'avec sa couverture (« coût connu sur X % de votre CA », forme à arbitrer) | profit brut, marge commerciale, gross margin, marge (nu, quand elle est mesurée : « marge » nu reste le mot de la marge DÉCLARÉE en %) |
