...
| Le préfixe de la ligne de recommandation d'une carte | **Action conseillée :** (owner 25/08 — lot 1 : extended_bad_weather, weather_hazard_onset, hour_share_move ; généralisation PAR LOTS, pas de ban mécanique tant que les ~80 autres cartes ne sont pas converties) | À adapter :, À exploiter :, À faire :, À pousser : (préfixes qui re-décrivent le signal avant d'agir) |
