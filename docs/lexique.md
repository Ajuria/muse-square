...
| Demander à l'exploitant une photo de composant (bloc « Composants » de la page du pôle) | **Documenter →** (CTA owner 03/09, inchangé) ; sous le titre du bloc, une fois : **Une photo par composant, et vous voyez ce qui est exposé sans se vendre — et ce qui se vend sans être exposé.** (proposé 13/09, à ratifier — le gain est bâti : `classifyPoleItems` rend « En retrait sur votre résultat habituel » et « Vendus sans être vus sur une photo ») | prenez une photo (nu), inventoriez, scannez votre rayon |
