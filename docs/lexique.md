...
| Le CA net HT qu'une journée doit générer pour couvrir sa part de charges fixes et de masse salariale | **point mort** (owner 11/09) ; « point mort du jour », « point mort atteint à N h » | seuil de rentabilité, break-even, chiffre à faire |
...
| Les charges du mois qui ne dépendent pas des ventes (loyer, énergie, abonnements…), déclarées comme UN montant mensuel à date d'effet | **charges fixes** (mot owner § 12.12, 11/09) ; avec la masse salariale, elles donnent le résultat net et le point mort | frais fixes, frais généraux, overhead, coûts de structure |
