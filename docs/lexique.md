...
| Déposer le plan du magasin (bandeau de la vue Dispositif) | **Déposez le plan de votre magasin** — celui de l'exploitant, avec ses numéros déjà imprimés (owner 15/09, voie b). | relever les meubles un par un sur le plan ; « importer », « téléverser » (règle 7 bis) |
