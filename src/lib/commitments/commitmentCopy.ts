...
export const EVOL_COPY = {
  ...
  pole_space_par_metre: "{ca} € de CA par mètre linéaire",
  pole_space_net_par_metre: "{ca} € de CA net HT par mètre linéaire",
  pole_space_marge_par_metre: "{ca} € de marge brute par mètre linéaire",
