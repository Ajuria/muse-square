...
import { OCC_CTE, COMPARABLE_LOOKBACK_DAYS, readEntityPeriod, buildEntityPeriodBlocks, periodLabelFr } from "../explorer/entityReading";
import type { KpiKey } from "../kpi/kpiRegistry";
