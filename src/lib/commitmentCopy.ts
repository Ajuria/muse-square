...
export const EVOL_COPY = {
  ...
  shape_fams_note: "Vos {n} familles, de la plus forte hausse à la plus forte baisse.",
  ...
  shape_vol_tx: "{tx} achats au lieu de {ref}",
  shape_vol_basket: "un panier de {b} € au lieu de {ref} €",
  shape_vol_opposed: "{down}, mais {up}.",
  shape_vol_same: "{first}, et {second}.",
  shape_vol_driver_tx: "Ce sont les achats qui font la journée : {eur} €.",
  shape_vol_driver_basket: "C’est le panier qui fait la journée : {eur} €.",
