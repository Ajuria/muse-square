...
export const EVOL_COPY = {
  ...
  diag_reinforce_title: "Renforcer l'exécution",
  diag_reinforce_body: "Remettre l'action en avant, sur chaque créneau concerné — même plan, mieux tenu.",
  diag_adjust_title: "Ajuster mon dispositif",
  diag_adjust_body: "Modifier l'offre, le canal ou le timing, puis remesurer sur une nouvelle fenêtre.",
