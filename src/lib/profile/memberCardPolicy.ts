...
// 08/09 — family_space_underuse : item_category = la famille qui pèse presque rien (payload mart).
const FAMILY_SCOPED = new Set(["item_share_move", "offering_mix_shift", "item_absent_regular", "family_price_move", "family_discount_move", "family_space_underuse"]);
