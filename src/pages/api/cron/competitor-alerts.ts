      ...
      query: `
        WITH conflicts AS (
          SELECT
            ...
            ce.conflict_score,
            ce.threat_score                 AS entity_threat_score,
            ce.threat_level                 AS entity_threat_level,
            ce.threat_audience_overlap_pct  AS entity_threat_audience_pct,
            ce.threat_industry_match_tier   AS entity_threat_industry_tier,
            ce.threat_seasonality_alignment AS entity_threat_seasonality_flag,
            ce.threat_distance_km           AS entity_threat_distance_km,
            ce.date_conflict,
            ce.industry_overlap,
            ce.audience_overlap,
            ce.distance_flag,
        ...
        overlap AS (
          SELECT
            ...
            c.conflict_score,
            c.entity_threat_score,
            c.entity_threat_level,
            c.entity_threat_audience_pct,
            c.entity_threat_industry_tier,
            c.entity_threat_seasonality_flag,
            c.entity_threat_distance_km,
            c.date_conflict,
            c.industry_overlap,
            c.audience_overlap,
            c.distance_flag,
      ...
      try {
        ...
        await bq.query({
          ...
          params: {
            ...
            entity_threat_seasonality_flag: row.entity_threat_seasonality_flag === true || row.entity_threat_seasonality_flag === "true" ? true : row.entity_threat_seasonality_flag === false || row.entity_threat_seasonality_flag === "false" ? false : null,
          ...
          types: {
            ...
            direction: "STRING",
            distance_m: "FLOAT64",
            conflict_score: "INT64",
            entity_threat_score: "FLOAT64",
            entity_threat_level: "STRING",
            entity_threat_audience_pct: "FLOAT64",
            entity_threat_industry_tier: "STRING",
            entity_threat_seasonality_flag: "BOOL",
            entity_threat_distance_km: "FLOAT64",
            watched_event_id: "STRING",
            watched_event_name: "STRING",
            created_at: "STRING",
          },
          location: BQ_LOCATION,
        });
