...
export const POST: APIRoute = async ({ request, locals }) => {
  try {
    ...
    await bigquery.query({
      ...
      types: {
        clerk_user_id: "STRING", location_id: "STRING", email: "STRING",
        first_name: "STRING", last_name: "STRING", position: "STRING",
        company_name: "STRING", company_address: "STRING", company_address_key: "STRING",
        city_id: "STRING", company_lat: "FLOAT64", company_lon: "FLOAT64",
        geocode_status: "STRING", company_activity_type: "STRING", location_type: "STRING",
        event_time_profile: "STRING", location_access_pattern: "STRING",
        nearest_transit_stop: "STRING", nearest_transit_stop_id: "STRING",
        nearest_transit_lines: "STRING", primary_audience_1: "STRING",
        primary_audience_2: "STRING", origin_city_id_1: "STRING", origin_city_id_2: "STRING",
        origin_city_id_3: "STRING", origin_city_label_1: "STRING",
        origin_city_label_2: "STRING", origin_city_label_3: "STRING",
      },
      location: BQ_LOCATION,
    });
