// Harnais proto DOSSIER (NON COMMITTÉ — support de tools/proto/dossier-proto.html).
...
// Lecture seule. Usage : npx tsx tools/generators/dossier-proto-data.ts
...
(async () => {
  ...
  const dest = new URL("../proto/dossier-proto-data.js", import.meta.url).pathname;
