// Harnais proto Tableau de bord (NON COMMITTÉ — support de tools/proto/tableau-proto.html).
...
// Lecture seule. Usage : npx tsx tools/generators/tableau-proto-data.ts
...
(async () => {
  ...
  const dest = new URL("../proto/tableau-proto-data.js", import.meta.url).pathname;
