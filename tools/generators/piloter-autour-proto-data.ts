...
// ne le portait pas) → tools/proto/piloter-autour-proto-data.js. Chaque carte de la maquette
// s'affiche OUVERTE avec ces données.
// Usage : npx tsx tools/generators/piloter-autour-proto-data.ts
...
(async () => {
  ...
  writeFileSync(new URL("../proto/piloter-autour-proto-data.js", import.meta.url).pathname,
