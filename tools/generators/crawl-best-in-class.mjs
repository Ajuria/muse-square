 ...
 *      INDUSTRIES=live_event LEVERS=conversion INTENTS=pivot node tools/generators/crawl-best-in-class.mjs   (subset, fast test)
 *      MODE=merge LEVERS=conversion INTENTS=pivot node tools/generators/crawl-best-in-class.mjs   (demand-drain: supersede ONLY these cells)
 *      MODE=refresh node tools/generators/crawl-best-in-class.mjs   (demand-drain: active verticals × stale/missing cells only)
 *
