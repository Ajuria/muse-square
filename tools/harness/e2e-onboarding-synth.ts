...
//
// Usage : npx tsx tools/harness/e2e-onboarding-synth.ts            (durée ~10-15 min, poll dbt)
//         npx tsx tools/harness/e2e-onboarding-synth.ts --invite   (+ invitation Clerk réelle vers
//                                                             l'adresse taguée owner : création,
//                                                             demande de fichier « sent », révocation)
//         npx tsx tools/harness/e2e-onboarding-synth.ts --purge    (purge seule, idempotente)
//
