...
with open(os.path.join(REF, "data/ref/city_map.csv"), "w", newline="", encoding="utf-8") as f:
    w = csv.writer(f)
...
with open(os.path.join(REF, "data/ref/communes_coords.csv"), "w", newline="", encoding="utf-8") as f:
    w = csv.writer(f)
...
with open(os.path.join(REF, "data/ref/departments_map.csv"), "w", newline="", encoding="utf-8") as f:
    w = csv.writer(f)
